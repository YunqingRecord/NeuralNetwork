...
model.add(Conv2D(input_shape=(32, 32, 3), filters=32,  kernel_size=(3, 3), strides=(1, 1), padding="SAME", kernel_initializer=stdev1))
model.add(MaxPooling2D(pool_size=2, strides=2, padding="SAME"))
model.add(LeakyReLU(alpha=0.3))
model.add(BatchNormalization())
model.add(Dropout(0.15))

model.add(Conv2D(filters=32,  kernel_size=(3, 3), strides=(1, 1), padding="SAME", kernel_initializer=stdev2))
...
model.add(Dense(500, kernel_initializer=stdev3))
model.add(LeakyReLU(alpha=0.3))
